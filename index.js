...
const who_to_greet = core.getInput('who_to_greet', {required: true} );
parameters['who_to_greet'] = who_to_greet

async function run (parameters){
    downloadJar()

    core.info('Running the Pipeline Scan')
    let scanCommandOutput = await runScan('java -jar opswat-0.0.1-SNAPSHOT.jar ' + parameters['who_to_greet'])
